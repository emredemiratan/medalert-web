  ...
  return (
    ...
    >
      <div className="flex mt-5 flex-col border-2 border-gray-400 p-4 gap-2 rounded-lg custom-card gray-bg mb-5">
        ...
        <div className="col-12 flex justify-center self-center w-1/2 border-2 border-gray-400 p-4 gap-2 rounded-lg bg-teal-200">
          <span>Nearest Hospital</span>
        </div>
        <div className="flex flex-row justify-center self-center w-1/2 border-2 border-gray-400 p-4 gap-2 rounded-lg bg-red-200">
